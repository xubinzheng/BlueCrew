...
/** Issue the query to the Mobile Data service to obtain a count of matching objects.

 The count method is a provisional API.  APIs that are marked provisional are evolving and might change or be removed in future releases.

 If successful, the result value of the returned BFTask is an NSNumber object containing the
 number of objects that match the query conditions.

 @return The BFTask that can be used to obtain the query result once the query is completed.
 */
- (BFTask *)count;
